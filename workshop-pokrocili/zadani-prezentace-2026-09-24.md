...
**Rozsah:** 21 slidů (vč. 12a, 12b, 12c), 16:9, česky · **Verze zadání:** 24. 9. 2026, v5 (Credix podle hovoru 24. 9.: slidy 6, 12, 17, nové slidy 12b a 12c – diagram bridge; v4: slide 16 SPV; v3: Home Credit, slide 12a; v2: místo a čas, startup ČS) · **Navazuje na:** `../workshop-zacatecnici/zadani-prezentace-2026-09-23.md` (stejný vizuální systém)
...
> 3b) Za slide 12b vlož slide 12c „Bridge úvěr: jak funguje“ podle sekce „Slide 12c“ a přiloženého obrázku bridge-uver.png: tmavě zelený slide, nahoře časová osa se třemi číslovanými body a třemi úseky (zlatý plný, zlatý čárkovaný, zelená šipka), pod ní tři karty s řádky parametr – hodnota (písmo min. 14 pt) a zlatými šipkami mezi nimi, dole pruh „Cena rychlosti“ se třemi velkými čísly v JetBrains Mono a zelená karta „vs. banka“. Texty doslova ze zadání, poznámky pro lektora do speaker notes.
...
> Ukaž mi nejdřív slidy 12b a 12c a upravenou matici bank.
...
| 12b | Credix: bridge financování | 4 | 19:34 | 2 |
| 12c | Bridge úvěr: jak funguje (všechny nebankovky) | 4 | 19:36 | 2 |
| 13 | Bonita právnické osoby | 5 · STRATEGIE | 19:38 | 4 |
...
### Slide 12c – Bridge úvěr: jak funguje (BLOK 4)

- **Účel:** princip bridge financování u nebankovek na jedné časové ose – nákup, držení, exit – a co rychlost stojí (zdroj: hovor s Credixem 24. 9. 2026; princip platí pro Credix, Fio i Home Credit).
- **Rozvržení:** tmavě zelený slide. Nahoře časová osa se třemi číslovanými body (1 zlatý plný úsek „Den 0 · ~10 pracovních dnů“, 2 zlatý čárkovaný úsek „Měsíc 1–12 (max. 36)“, 3 zelená šipka „Exit · 6–12 měsíců po nákupu“). Pod osou tři karty vedle sebe (řádky parametr – hodnota), mezi nimi zlaté šipky. Dole vlevo pruh „Cena rychlosti“ se třemi velkými čísly, vpravo zelená karta „vs. banka“. Předloha: `grafika/bridge-uver.png`.
- **Obsah slidu – karta 1 NÁKUP PŘES NEBANKOVKU (zlatá):** Rychlost – schválení i čerpání ~10 pracovních dnů · LTV – 65–80 % podle typu a lokality · Vlastní zdroje – min. 20 % (v rámci skupiny i 0 %) · Poplatek – do 2 % z úvěrového rámce · Zástava – kupovaná nemovitost, případně vlastní / skupina
- **Obsah slidu – karta 2 BRIDGE: DRŽÍM A CHYSTÁM BANKU (zlatá):** Sazba – 9–10 % Credix, 8,5–10,5 % Home Credit · Splácím – jen měsíční úrok z nájmů, jistina až na konci · Nájmy – nastavím smlouvy, 6–12 měsíců chodí na účet nebo do DP · Hodnota – rekonstrukce / prohlášení vlastníka → vyšší ocenění · Alternativa – balon: kapitalizace úroků do jistiny
- **Obsah slidu – karta 3 EXIT: REFINANCOVÁNÍ DO BANKY (zelená):** Kam – nejčastěji Moneta, Živnohypotéka až 30 let · Sazba – o ~3 p. b. níž než nebankovka · Jistina – splatí ji banka, nebankovka odchází · Exit fee – do 1 roku 2–3 %, pak 0 % (lze 0 % po 6 měsících) · Alternativa – prodej po rozdělení na jednotky
- **Obsah slidu – pruh CENA RYCHLOSTI · příklad 10 mil. Kč na 12 měsíců:** **950 000 Kč** úrok 9,5 % u nebankovky · **+ 200 000 Kč** poplatek 2 % · **+ 0–300 000 Kč** exit fee 0–3 %
- **Obsah slidu – karta VS. BANKA 6,5 %: 650 000 Kč:** Rok u nebankovky stojí o 0,5–0,8 mil. Kč víc. Vyplatí se, když rychlost rozhodne o koupi nebo když banka zatím nájmy neuzná.
- **Patička slidu:** Princip platí pro Credix, Fio i Home Credit – liší se sazby, LTV a poplatky (Home Credit splácí anuitně, balon nedělá). Ilustrativní čísla k 24. 9. 2026.
- **Lektor říká:** nebankovka není konkurence banky, ale její předstupeň. Klient u ní nekončí – kupuje rychle, nastaví nájmy a za půl roku až rok jde do banky o tři procentní body levněji. Moneta dokonce parkuje své klienty u Credixu na nákup a pak je refinancuje. Otázka není „banka, nebo nebankovka“, ale „kolik mě stojí rok, který mi koupí nemovitost“.
